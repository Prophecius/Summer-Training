...
$pretrained_model=""D:\工作\SD\stable-diffusion-webui\models\Stable-diffusion\v1-5-pruned-emaonly.safetensors"" # base model path | 底模路径
$train_data_dir="D:\工作\SD\stable-diffusion-webui\models\Stable-diffusion\data"
...
$output_name = "model1" # output model name | 模型保存名称
